...
TypeVariant::NesterNestedUnion => Ok(Self::NesterNestedUnion(Box::new(NesterNestedUnion::arbitrary(u)?))),
            ...
            pub fn default<'a>(v: TypeVariant) -> Self {
                match v {
                    TypeVariant::Uint512 => Self::Uint512(Box::new(Uint512::default())),
TypeVariant::Uint513 => Self::Uint513(Box::new(Uint513::default())),
TypeVariant::Uint514 => Self::Uint514(Box::new(Uint514::default())),
TypeVariant::Str => Self::Str(Box::new(Str::default())),
TypeVariant::Str2 => Self::Str2(Box::new(Str2::default())),
TypeVariant::Hash => Self::Hash(Box::new(Hash::default())),
TypeVariant::Hashes1 => Self::Hashes1(Box::new(Hashes1::default())),
TypeVariant::Hashes2 => Self::Hashes2(Box::new(Hashes2::default())),
TypeVariant::Hashes3 => Self::Hashes3(Box::new(Hashes3::default())),
TypeVariant::OptHash1 => Self::OptHash1(Box::new(OptHash1::default())),
TypeVariant::OptHash2 => Self::OptHash2(Box::new(OptHash2::default())),
TypeVariant::Int1 => Self::Int1(Box::new(Int1::default())),
TypeVariant::Int2 => Self::Int2(Box::new(Int2::default())),
TypeVariant::Int3 => Self::Int3(Box::new(Int3::default())),
TypeVariant::Int4 => Self::Int4(Box::new(Int4::default())),
TypeVariant::MyStruct => Self::MyStruct(Box::new(MyStruct::default())),
TypeVariant::LotsOfMyStructs => Self::LotsOfMyStructs(Box::new(LotsOfMyStructs::default())),
TypeVariant::HasStuff => Self::HasStuff(Box::new(HasStuff::default())),
TypeVariant::Color => Self::Color(Box::new(Color::default())),
TypeVariant::Nester => Self::Nester(Box::new(Nester::default())),
TypeVariant::NesterNestedEnum => Self::NesterNestedEnum(Box::new(NesterNestedEnum::default())),
TypeVariant::NesterNestedStruct => Self::NesterNestedStruct(Box::new(NesterNestedStruct::default())),
TypeVariant::NesterNestedUnion => Self::NesterNestedUnion(Box::new(NesterNestedUnion::default())),
                }
            }
