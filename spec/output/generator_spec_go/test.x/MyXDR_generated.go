...
func (s *Uint512) DecodeFrom(d *xdr.Decoder, maxDepth uint, maxAllocSize int) (int, error) {
  if maxDepth == 0 {
...
// DecodeFrom decodes this value using the Decoder.
func (s *Uint513) DecodeFrom(d *xdr.Decoder, maxDepth uint, maxAllocSize int) (int, error) {
  if maxDepth == 0 {
  ...
  var err error
  var n, nTmp int
  (*s), nTmp, err = d.DecodeOpaque(mergeMaxAllocSizeAndMaxSize(maxAllocSize, 64))
n += nTmp
if err != nil {
...
// DecodeFrom decodes this value using the Decoder.
func (s *Uint514) DecodeFrom(d *xdr.Decoder, maxDepth uint, maxAllocSize int) (int, error) {
  if maxDepth == 0 {
  ...
  var err error
  var n, nTmp int
  (*s), nTmp, err = d.DecodeOpaque(maxAllocSize)
n += nTmp
if err != nil {
...
// DecodeFrom decodes this value using the Decoder.
func (s *Str) DecodeFrom(d *xdr.Decoder, maxDepth uint, maxAllocSize int) (int, error) {
  if maxDepth == 0 {
  ...
  var n, nTmp int
  var v string
  v, nTmp, err = d.DecodeString(mergeMaxAllocSizeAndMaxSize(maxAllocSize, 64))
n += nTmp
if err != nil {
...
// DecodeFrom decodes this value using the Decoder.
func (s *Str2) DecodeFrom(d *xdr.Decoder, maxDepth uint, maxAllocSize int) (int, error) {
  if maxDepth == 0 {
  ...
  var n, nTmp int
  var v string
  v, nTmp, err = d.DecodeString(maxAllocSize)
n += nTmp
if err != nil {
...
// DecodeFrom decodes this value using the Decoder.
func (s *Hash) DecodeFrom(d *xdr.Decoder, maxDepth uint, maxAllocSize int) (int, error) {
  if maxDepth == 0 {
...
// DecodeFrom decodes this value using the Decoder.
func (s *Hashes1) DecodeFrom(d *xdr.Decoder, maxDepth uint, maxAllocSize int) (int, error) {
  if maxDepth == 0 {
  ...
  var n, nTmp int
  for i := 0; i < len(s); i++ {
      nTmp, err = s[i].DecodeFrom(d, maxDepth, maxAllocSize)
n += nTmp
if err != nil {
  return n, fmt.Errorf("decoding Hash: %w", err)
}
...
// DecodeFrom decodes this value using the Decoder.
func (s *Hashes2) DecodeFrom(d *xdr.Decoder, maxDepth uint, maxAllocSize int) (int, error) {
  if maxDepth == 0 {
...
if err != nil {
  ...
  if maxAllocSize > 0 {
    var phony Hash
    allocSize := unsafe.Sizeof(phony) * uintptr(l)
    if uintptr(maxAllocSize) < allocSize {
      return n, fmt.Errorf("decoding Hash: allocation size (%d) exceeds limit (%d)", allocSize, maxAllocSize)
    }
  }
  (*s) = nil
  if l > 0 {
...
// DecodeFrom decodes this value using the Decoder.
func (s *Hashes3) DecodeFrom(d *xdr.Decoder, maxDepth uint, maxAllocSize int) (int, error) {
  if maxDepth == 0 {
...
// DecodeFrom decodes this value using the Decoder.
func (s *Int1) DecodeFrom(d *xdr.Decoder, maxDepth uint, maxAllocSize int) (int, error) {
  if maxDepth == 0 {
...
// DecodeFrom decodes this value using the Decoder.
func (s *Int2) DecodeFrom(d *xdr.Decoder, maxDepth uint, maxAllocSize int) (int, error) {
  if maxDepth == 0 {
...
// DecodeFrom decodes this value using the Decoder.
func (s *Int3) DecodeFrom(d *xdr.Decoder, maxDepth uint, maxAllocSize int) (int, error) {
  if maxDepth == 0 {
...
// DecodeFrom decodes this value using the Decoder.
func (s *Int4) DecodeFrom(d *xdr.Decoder, maxDepth uint, maxAllocSize int) (int, error) {
  if maxDepth == 0 {
...
// DecodeFrom decodes this value using the Decoder.
func (s *MyStruct) DecodeFrom(d *xdr.Decoder, maxDepth uint, maxAllocSize int) (int, error) {
  if maxDepth == 0 {
  ...
  var err error
  var n, nTmp int
  nTmp, err = s.Field1.DecodeFrom(d, maxDepth, maxAllocSize)
n += nTmp
if err != nil {
  return n, fmt.Errorf("decoding Uint512: %w", err)
}
...
if err != nil {
  ...
  if b {
     s.Field2 = new(Hash)
  nTmp, err = s.Field2.DecodeFrom(d, maxDepth, maxAllocSize)
n += nTmp
if err != nil {
  return n, fmt.Errorf("decoding OptHash1: %w", err)
}
  }
  nTmp, err = s.Field3.DecodeFrom(d, maxDepth, maxAllocSize)
n += nTmp
if err != nil {
...
if err != nil {
  ...
  nTmp, err = d.DecodeWithMaxDepth(&s.Field5, maxDepth, maxAllocSize)
n += nTmp
if err != nil {
  return n, fmt.Errorf("decoding Float: %w", err)
}
  nTmp, err = d.DecodeWithMaxDepth(&s.Field6, maxDepth, maxAllocSize)
n += nTmp
if err != nil {
...
// DecodeFrom decodes this value using the Decoder.
func (s *LotsOfMyStructs) DecodeFrom(d *xdr.Decoder, maxDepth uint, maxAllocSize int) (int, error) {
  if maxDepth == 0 {
...
if err != nil {
  ...
  if maxAllocSize > 0 {
    ...
    allocSize := unsafe.Sizeof(phony) * uintptr(l)
    if uintptr(maxAllocSize) < allocSize {
      return n, fmt.Errorf("decoding MyStruct: allocation size (%d) exceeds limit (%d)", allocSize, maxAllocSize)
    }
  }
  s.Members = nil
  if l > 0 {
    ...
    for i := uint32(0); i < l; i++ {
      nTmp, err = s.Members[i].DecodeFrom(d, maxDepth, maxAllocSize)
n += nTmp
if err != nil {
  return n, fmt.Errorf("decoding MyStruct: %w", err)
}
...
// DecodeFrom decodes this value using the Decoder.
func (s *HasStuff) DecodeFrom(d *xdr.Decoder, maxDepth uint, maxAllocSize int) (int, error) {
  if maxDepth == 0 {
  ...
  var err error
  var n, nTmp int
  nTmp, err = s.Data.DecodeFrom(d, maxDepth, maxAllocSize)
n += nTmp
if err != nil {
...
// DecodeFrom decodes this value using the Decoder.
func (e *Color) DecodeFrom(d *xdr.Decoder, maxDepth uint, maxAllocSize int) (int, error) {
  if maxDepth == 0 {
...
// DecodeFrom decodes this value using the Decoder.
func (e *NesterNestedEnum) DecodeFrom(d *xdr.Decoder, maxDepth uint, maxAllocSize int) (int, error) {
  if maxDepth == 0 {
...
// DecodeFrom decodes this value using the Decoder.
func (s *NesterNestedStruct) DecodeFrom(d *xdr.Decoder, maxDepth uint, maxAllocSize int) (int, error) {
  if maxDepth == 0 {
...
// DecodeFrom decodes this value using the Decoder.
func (u *NesterNestedUnion) DecodeFrom(d *xdr.Decoder, maxDepth uint, maxAllocSize int) (int, error) {
  if maxDepth == 0 {
  ...
  var err error
  var n, nTmp int
  nTmp, err = u.Color.DecodeFrom(d, maxDepth, maxAllocSize)
n += nTmp
if err != nil {
  return n, fmt.Errorf("decoding Color: %w", err)
}
...
// DecodeFrom decodes this value using the Decoder.
func (s *Nester) DecodeFrom(d *xdr.Decoder, maxDepth uint, maxAllocSize int) (int, error) {
  if maxDepth == 0 {
  ...
  var err error
  var n, nTmp int
  nTmp, err = s.NestedEnum.DecodeFrom(d, maxDepth, maxAllocSize)
n += nTmp
if err != nil {
  return n, fmt.Errorf("decoding NesterNestedEnum: %w", err)
}
  nTmp, err = s.NestedStruct.DecodeFrom(d, maxDepth, maxAllocSize)
n += nTmp
if err != nil {
  return n, fmt.Errorf("decoding NesterNestedStruct: %w", err)
}
  nTmp, err = s.NestedUnion.DecodeFrom(d, maxDepth, maxAllocSize)
n += nTmp
if err != nil {
