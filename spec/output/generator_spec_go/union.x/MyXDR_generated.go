...
// DecodeFrom decodes this value using the Decoder.
func (s *Multi) DecodeFrom(d *xdr.Decoder) (int, error) {
  var err error
  var n, nTmp int
  var v int32
  v, nTmp, err = d.DecodeInt()
...
switch UnionKey(aType) {
    ...
    case UnionKeyMulti:
                  tv, ok := value.([]Multi)
            if !ok {
              err = fmt.Errorf("invalid value, must be []Multi")
              return
            }
            result.Things = &tv
}
...
n += nTmp
if err != nil {
  return n, fmt.Errorf("decoding Multi: %s", err)
}
  (*u.Things) = nil
  if l > 0 {
    (*u.Things) = make([]Multi, l)
    for i := uint32(0); i < l; i++ {
      nTmp, err = (*u.Things)[i].DecodeFrom(d)
n += nTmp
if err != nil {
  return n, fmt.Errorf("decoding Multi: %s", err)
}
...
// DecodeFrom decodes this value using the Decoder.
func (u *IntUnion) DecodeFrom(d *xdr.Decoder) (int, error) {
  var err error
  var n, nTmp int
...
// DecodeFrom decodes this value using the Decoder.
func (s *IntUnion2) DecodeFrom(d *xdr.Decoder) (int, error) {
  var err error
  var n, nTmp int
  nTmp, err = (*IntUnion)(s).DecodeFrom(d)
n += nTmp
if err != nil {
  return n, fmt.Errorf("decoding IntUnion: %s", err)
}
  return n, nil
}
...
// SwitchFieldName returns the field name in which this union's
// discriminant is stored
func (u IntUnion3) SwitchFieldName() string {
  return "Type"
}

// ArmForSwitch returns which field name should be used for storing
// the value for an instance of IntUnion3
func (u IntUnion3) ArmForSwitch(sw int32) (string, bool) {
switch int32(sw) {
    case 0:
      return "Error", true
    case 1000:
...
// NewIntUnion3 creates a new  IntUnion3.
func NewIntUnion3(aType int32, value interface{}) (result IntUnion3, err error) {
  result.Type = aType
switch int32(aType) {
    case 0:
                  tv, ok := value.(Error)
...
// MustError retrieves the Error value from the union,
// panicing if the value is not set.
func (u IntUnion3) MustError() Error {
  val, ok := u.GetError()
...
// GetError retrieves the Error value from the union,
// returning ok if the union's switch indicated the value is valid.
func (u IntUnion3) GetError() (result Error, ok bool) {
  armName, _ := u.ArmForSwitch(int32(u.Type))
...
// MustThings retrieves the Things value from the union,
// panicing if the value is not set.
func (u IntUnion3) MustThings() []Multi {
  val, ok := u.GetThings()
...
// GetThings retrieves the Things value from the union,
// returning ok if the union's switch indicated the value is valid.
func (u IntUnion3) GetThings() (result []Multi, ok bool) {
  armName, _ := u.ArmForSwitch(int32(u.Type))
...
// EncodeTo encodes this value using the Encoder.
func (u IntUnion3) EncodeTo(e *xdr.Encoder) error {
  var err error
if _, err = e.EncodeInt(int32(u.Type)); err != nil {
  return err
}
...
return nil
  ...
  return fmt.Errorf("Type (int32) switch value '%d' is not valid for union IntUnion3", u.Type)
}

var _ decoderFrom = (*IntUnion3)(nil)
// DecodeFrom decodes this value using the Decoder.
func (u *IntUnion3) DecodeFrom(d *xdr.Decoder) (int, error) {
  var err error
  var n, nTmp int
  u.Type, nTmp, err = d.DecodeInt()
n += nTmp
...
if err != nil {
  ...
  return n, fmt.Errorf("union IntUnion3 has invalid Type (int32) switch value '%d'", u.Type)
}

// MarshalBinary implements encoding.BinaryMarshaler.
func (s IntUnion3) MarshalBinary() ([]byte, error) {
  b := bytes.Buffer{}
  e := xdr.NewEncoder(&b)
  err := s.EncodeTo(e)
  return b.Bytes(), err
...
// UnmarshalBinary implements encoding.BinaryUnmarshaler.
func (s *IntUnion3) UnmarshalBinary(inp []byte) error {
  r := bytes.NewReader(inp)
  d := xdr.NewDecoder(r)
  _, err := s.DecodeFrom(d)
  return err
...
var (
  _ encoding.BinaryMarshaler   = (*IntUnion3)(nil)
  _ encoding.BinaryUnmarshaler = (*IntUnion3)(nil)
)

// xdrType signals that this type is an type representing
// representing XDR values defined by this package.
func (s IntUnion3) xdrType() {}

var _ xdrType = (*IntUnion3)(nil)
